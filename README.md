...
<p align="center">
  <img
    src="https://skillicons.dev/icons?i=aws,docker,graphql,figma,gcp,mongo,nodejs,ts,postman,git,postgres,nestjs&perline=4#gh-dark-mode-only"
  />
  <img
    src="https://skillicons.dev/icons?i=aws,docker,graphql,figma,gcp,mongo,nodejs,ts,postman,git,postgres,nestjs&perline=4&theme=light#gh-light-mode-only"
  />
</p>
<br>
